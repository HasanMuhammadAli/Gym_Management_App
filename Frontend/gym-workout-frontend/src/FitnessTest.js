      ...
      {phoneNo && (
        <div onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-gray-600 mb-1">10-min Run (bpm)</label>
                <input
                  type="number"
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-gray-600 mb-1">BPM Before Test</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-gray-600 mb-1">BPM After Test</label>
                <input
                  type="number"
                  name="bpm_after_test"
